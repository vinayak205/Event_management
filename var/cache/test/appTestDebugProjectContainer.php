...
class appTestDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HGobavqEgm', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Vqrb3Jg6dS', '', '3SAHqOf4Or4MHUH1xW9kgA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FF8x5HcN0e', '', '3SAHqOf4Or4MHUH1xW9kgA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F21Ou7mezS', '', '3SAHqOf4Or4MHUH1xW9kgA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'event_management', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_abc84e301ae2780df70d10bf4cddb0326d24ee1e247bdab08a3b7381d08afed0');
    ...
    /**
     * Gets the 'monolog.handler.sentry' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Monolog\Handler\RavenHandler A Monolog\Handler\RavenHandler instance
     */
    protected function getMonolog_Handler_SentryService()
    {
        return $this->services['monolog.handler.sentry'] = new \Monolog\Handler\RavenHandler(new \Raven_Client('https://ae54fe264deb4a89a2940d7dda02f6d1:6be4d59109f743349a6e394201b52939@app.getsentry.com/94573', array('auto_log_stacks' => false)), 250, true);
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/venue/list');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/venue/details/*');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/venue/*');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/list');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/pending/*');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/add');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/approve/*');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/reject/*');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/*');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/users/*');

        $s = new \Symfony\Component\Security\Http\AccessMap();
        $s->add($h, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $s->add($i, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $s->add($j, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $s->add($k, array(0 => 'ROLE_ADMIN'), NULL);
        $s->add($l, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $s->add($m, array(0 => 'ROLE_ADMIN'), NULL);
        $s->add($n, array(0 => 'ROLE_USER'), NULL);
        $s->add($o, array(0 => 'ROLE_ADMIN'), NULL);
        $s->add($p, array(0 => 'ROLE_ADMIN'), NULL);
        $s->add($q, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($s, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.our_db_provider')), 'main', $a, $c, $d), 2 => $u, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $t, 'main', $v, $w, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '57c339b31b75a8.83707964', $a, $g), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('debug.security.access.decision_manager'), $s, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $d, $t, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $t, 'login', false), NULL, NULL, $a, false));
    }
    ...
    /**
     * Gets the 'sentry.client' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sentry\SentryBundle\SentrySymfonyClient A Sentry\SentryBundle\SentrySymfonyClient instance
     */
    protected function getSentry_ClientService()
    {
        $this->services['sentry.client'] = $instance = new \Sentry\SentryBundle\SentrySymfonyClient('https://ae54fe264deb4a89a2940d7dda02f6d1:6be4d59109f743349a6e394201b52939@app.getsentry.com/94573');

        $instance->setRelease(NULL);
        $instance->setEnvironment('test');
        $instance->setAppPath(NULL);
        $instance->setPrefixes(array());
        $instance->install();
    ...
    /**
     * Gets the 'sentry.exception_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sentry\SentryBundle\EventListener\ExceptionListener A Sentry\SentryBundle\EventListener\ExceptionListener instance
     */
    protected function getSentry_ExceptionListenerService()
    {
        return $this->services['sentry.exception_listener'] = new \Sentry\SentryBundle\EventListener\ExceptionListener($this->get('security.token_storage', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('security.authorization_checker', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('sentry.client'), array(0 => 'Symfony\\Component\\HttpKernel\\Exception\\HttpExceptionInterface'));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('c2e6a47b99242f58ba61ef64eb6c801a4bb44f8a');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'c2e6a47b99242f58ba61ef64eb6c801a4bb44f8a',
            'locale' => 'en',
            'event_image_directory' => ($this->targetDirs[3].'/app/../web/asset/eventimages'),
            'venue_image_directory' => ($this->targetDirs[3].'/app/../web/asset/venueimages'),
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'c2e6a47b99242f58ba61ef64eb6c801a4bb44f8a',
            ...
            'sentry.dsn' => 'https://ae54fe264deb4a89a2940d7dda02f6d1:6be4d59109f743349a6e394201b52939@app.getsentry.com/94573',
            'sentry.app_path' => NULL,
